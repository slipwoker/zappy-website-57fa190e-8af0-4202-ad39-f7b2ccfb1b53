    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דניאל קוסמטיקס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '57fa190e-8af0-4202-ad39-f7b2ccfb1b53',
                    name: data.name || '',
                    email: data.email || '',
